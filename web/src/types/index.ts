...
export interface Visit {
  ...
  gender: string;
  patient?: Patient;
  prescribed_drugs?: PrescribedDrug[];
...
export interface CreateVisitInput {
  patient_id: number;
  raw_input: string;
  ai_result: PreviewVisitResponse;
}

export interface PreviewVisitInput {
  raw_input: string;
}

export interface PreviewVisitResponse {
  drugs: object[];
  lab_tests: string[];
  notes: string;
}
...
export interface VisitQueryOptions extends QueryOptions {
  name: string;
}
...
export interface BillingQueryOptions extends QueryOptions {
  name: string;
}

export interface DrugQueryOptions extends QueryOptions {
  name: string;
}

export interface LabTestQueryOptions extends QueryOptions {
  name: string;
}
...
export interface DrugPaginator extends PaginatorInfo<Drug> {}

export interface LabTestPaginator extends PaginatorInfo<LabTest> {}

export interface VisitPaginator extends PaginatorInfo<Visit> {}

export interface BillingPaginator extends PaginatorInfo<Billing> {}
