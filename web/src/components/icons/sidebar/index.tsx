...
export { MedicinePillsIcon } from '@/components/icons/sidebar/medicine-pills';
export { FlaskLabMedicalIcon } from '@/components/icons/sidebar/flask-lab-medical';
export { BillIcon } from '@/components/icons/sidebar/bill';
